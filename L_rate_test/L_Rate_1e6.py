...
checkpoint = keras.callbacks.ModelCheckpoint(
    filepath='checkpoint/best_model_effnet_L_Rate_1e6',
    save_best_only= True,
...
#
# plot_hist(model_run)
# plt.savefig('Accuracy Curve_Base_L_Rate_1e6')
# plt.show()
#
# plot_hist_loss(model_run)
# plt.savefig('Loss Curve_L_Rate_1e6')
# plt.show()
model = tf.keras.models.load_model(filepath='checkpoint/best_model_effnet_L_Rate_1e6')
