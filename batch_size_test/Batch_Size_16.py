...
checkpoint = keras.callbacks.ModelCheckpoint(
    filepath='checkpoint/best_model_effnet_Batch_Size_16',
    save_best_only= True,
...
# plot_hist(model_run)
# plt.savefig('Accuracy Curve_Batch_Size_16')
# plt.show()
#
# plot_hist_loss(model_run)
# plt.savefig('Loss Curve_Batch_Size_16')
# plt.show()
model = tf.keras.models.load_model(filepath='checkpoint/best_model_effnet_Batch_Size_16')
