...
checkpoint = keras.callbacks.ModelCheckpoint(
    filepath='checkpoint/best_model_effnet_Batch_Size_32',
    save_best_only= True,
...
#
# plot_hist(model_run)
# plt.savefig('Accuracy Curve_Base_Model_Batch_Size_32')
# plt.show()
#
# plot_hist_loss(model_run)
# plt.savefig('Loss Curve_Base_Model_Batch_Size_32')
# plt.show()
model = tf.keras.models.load_model(filepath='checkpoint/best_model_effnet_Batch_Size_32')
