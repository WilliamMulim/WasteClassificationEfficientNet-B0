...
checkpoint = keras.callbacks.ModelCheckpoint(
    filepath='checkpoint/best_model_effnet_RMSProp_w_Momentum',
    save_best_only= True,
...
#
# plot_hist(model_run)
# plt.savefig('Accuracy Curve_Base_RMSProp_w_Momentum')
# plt.show()
#
# plot_hist_loss(model_run)
# plt.savefig('Loss Curve_base_RMSProp_w_Momentum')
# plt.show()
model = tf.keras.models.load_model(filepath='checkpoint/best_model_effnet_RMSProp_w_Momentum')
