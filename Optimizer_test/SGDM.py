...
#
# plot_hist(model_run)
# plt.savefig('Accuracy Curve_Base_SGDM')
# plt.show()
#
# plot_hist_loss(model_run)
# plt.savefig('Loss Curve_base_SGDM')
# plt.show()
model = tf.keras.models.load_model(filepath='checkpoint/best_model_effnet_SGDM')
