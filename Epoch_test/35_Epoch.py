...
checkpoint = keras.callbacks.ModelCheckpoint(
    filepath='checkpoint/best_model_effnet_35_Epochs',
    save_best_only= True,
    monitor='val_accuracy',
    mode='max'
)

# model_run = model.fit(train_ds, validation_data=test_ds, epochs=35, callbacks=[checkpoint])
#
# plot_hist(model_run)
# plt.savefig('Accuracy Curve_Base_35_Epochs')
# plt.show()
#
# plot_hist_loss(model_run)
# plt.savefig('Loss Curve_35_Epochs')
# plt.show()
model = tf.keras.models.load_model(filepath='checkpoint/best_model_effnet_35_Epochs')
