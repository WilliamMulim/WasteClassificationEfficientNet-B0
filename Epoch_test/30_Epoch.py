...
checkpoint = keras.callbacks.ModelCheckpoint(
    filepath='checkpoint/best_model_effnet_30_Epochs',
    save_best_only= True,
...
#
# plot_hist(model_run)
# plt.savefig('Accuracy Curve_Base_30_Epochs')
# plt.show()
#
# plot_hist_loss(model_run)
# plt.savefig('Loss Curve_30_Epochs')
# plt.show()
model = tf.keras.models.load_model(filepath='checkpoint/best_model_effnet_30_Epochs')
